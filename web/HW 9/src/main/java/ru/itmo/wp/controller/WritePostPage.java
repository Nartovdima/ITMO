...
public class WritePostPage extends Page {
    ...
    public String writePostPost(@Valid @ModelAttribute("post") PostData postData,
        ...
        userService.writePost(getUser(httpSession), postData.toPost(), postData.getParsedTags());
