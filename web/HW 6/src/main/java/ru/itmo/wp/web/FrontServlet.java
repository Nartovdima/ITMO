...
public class FrontServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        targetFreemarkerConfiguration = newFreemarkerConfiguration(getServletContext().getRealPath("WEB-INF/templates"), true);
    }
    ...
    private void process(Route route,
        ...
        try{
            pageClass.getMethod("before", HttpServletRequest.class, Map.class).invoke(page, request, view);
        ...
        try{
            pageClass.getMethod("after", HttpServletRequest.class, Map.class).invoke(page, request, view);
        } catch (NoSuchMethodException | IllegalAccessException | InvocationTargetException ignored) {
            // no op
        }
